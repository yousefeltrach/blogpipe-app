import { Client } from "@gadget-client/y-blogpipe-develop";
...
export interface AmbientContext {
  ...
  sessionID?: string;
  /** All Y Blogpipe Develop configuration values */
  config: AppConfiguration;
  /** A map of connection name to instantiated connection objects for Y Blogpipe Develop */
  connections: AppConnections;
  /** A high performance structured logger which writes logs to the Logs Viewer in the Gadget Editor. */
  logger: FastifyLoggerInstance;
  /**
   * An instance of the API client for Y Blogpipe Develop.
   *
